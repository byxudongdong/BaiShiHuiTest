...
public class FaJianSQLite {
	...
	public FaJianSQLite(String billCode, String nextSite, String vehicleNo,
			String scanTime, String scanDate,String x_Auth_User,String x_Auth_Site,int send_flag) {
		super();
		BillCode = billCode;
		NextSite = nextSite;
		VehicleNo = vehicleNo;
	...
	public int getSend_up_flag() {
		return send_up_flag;
	}

	public void setSend_up_flag(int send_up_flag) {
		this.send_up_flag = send_up_flag;
	}
